...
class Servers extends Controller
{
    ...
    public function viewBackups($serverid)
    {
        ...
        $backupSchedule = json_decode(json_encode($this->vultr->backup_get_schedule([], [
            'SUBID' => $serverid,
        ])), false);
    ...
    public function backupEnable(Request $request)
    {
        ...
        $enablebackup = $this->vultr->backup_enable([], $data);
    ...
    public function backupSetSchedule(Request $request)
    {
        ...
        $setschedule = $this->vultr->backup_set_schedule([], $data);
    ...
    public function backupDisable(Request $request)
    {
        ...
        $setschedule = $this->vultr->backup_disable([], $data);
    ...
    public function start(Request $request)
    {
        ...
        $destroyRes = $this->vultr->start([], $data);
    ...
    public function halt(Request $request)
    {
        ...
        $destroyRes = $this->vultr->halt([], $data);
    ...
    public function reinstall(Request $request)
    {
        ...
        $destroyRes = $this->vultr->reinstall([], $data);
