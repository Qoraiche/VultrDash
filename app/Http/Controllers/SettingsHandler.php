...
public function firewallGroupSet( Request $request )
    {
        ...
        $setFirewallgroup = $this->vultr->firewall_group_set( array(), $data );
    ...
    public function isoAttach( Request $request )
    {
        ...
        $attachIso = $this->vultr->iso_attach( array(), $data );
    ...
    public function isoDetach( Request $request )
    {
        ...
        $detachiso = $this->vultr->iso_detach( array(), $data );
    ...
    public function labelSet( Request $request )
    {
        ...
        $setlabel = $this->vultr->label_set( array(), $data );
    ...
    public function restoreSnapshot( Request $request )
    {
        ...
        $snaprestore = $this->vultr->restore_snapshot( array(), $data );
    ...
    public function tagSet( Request $request )
    {
        ...
        $settag = $this->vultr->tag_set( array(), $data );
    ...
    public function upgradePlan( Request $request )
    {
        ...
        $planupgrade = $this->vultr->upgrade_plan( array(), $data );
    ...
    public function osChange( Request $request )
    {
        ...
        $changeos = $this->vultr->os_change( array(), $data );
    ...
    public function appChange( Request $request )
    {
        ...
        $changeapp = $this->vultr->app_change( array(), $data );
